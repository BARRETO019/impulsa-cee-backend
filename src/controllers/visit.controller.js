...
exports.addEnvelopeElement = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      ...
      (visit_id, tipo, nombre, superficie, orientacion, transmitancia, observaciones)
      VALUES ($1, $2, $3, $4, $5, $6, $7)
      RETURNING *`,
      [visit_id, tipo, nombre, superficie, orientacion, transmitancia || 0, observaciones]
    );
...
exports.addWindow = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      ...
      VALUES ($1, $2, $3, $4, $5, $6)
      RETURNING *`,
      [visit_id, nombre, superficie, orientacion || 'N/A', marco, vidrio]
    );
...
exports.addInstallation = async (req, res) => {
  try {
    ...
    const result = await pool.query(
      ...
      (visit_id, tipo, combustible, generador, potencia_nominal, ano_instalacion, observaciones) 
      VALUES ($1, $2, $3, $4, $5, $6, $7) 
      RETURNING *`,
      [
        visit_id, 
        tipo, 
        energia,           // Se guarda en 'combustible'
        marca_modelo,     // Se guarda en 'generador'
        potencia || 0,     // Se guarda en 'potencia_nominal'
        ano_aprox || null, // Se guarda en 'ano_instalacion'
        observaciones
      ]
    );
